class User < ActiveRecord::Base
  ...
  #########################################
  attr_accessible :name, :email, :current_password, :password, :password_confirmation, :remember_me, :photo, :invitation_token, :invited_by_id, :invited_by_type, :notify, :handicap, :buddy, :gender
